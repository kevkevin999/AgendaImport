...
sessions = db_table("sessions", { "id": "integer PRIMARY KEY", 
                                "date": "date", 
                                "time_start": "text", 
                                "time_end": "text", 
                                "title": "text", 
...
subsessions = db_table("subsessions", {"id": "integer PRIMARY KEY",
                                "parent_id" : "integer", 
                                "date": "date", 
                                "time_start": "text",
                                "time_end": "text",
...
speakers = db_table("speaker", {   "name": "text", 
